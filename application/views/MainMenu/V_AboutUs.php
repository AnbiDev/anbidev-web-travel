				...
				<div class="row">
					<div class="col-md-6">
						<div class="about animate-box">
							...
							<p>
					<?php echo isset($about[0]['about'])?$about[0]['about']:'Deskripsi tidak dapat ditampilkan'; ?>
							</p>
						</div>
					</div>
					<div class="col-md-6">
						<img class="img-responsive" src="<?php echo base_url(); ?>assets/images/landing/img_bg_5.jpg" alt="Free HTML5 Bootstrap Template by colorlib.com">
					</div>
				</div>
			</div>
		</div>
