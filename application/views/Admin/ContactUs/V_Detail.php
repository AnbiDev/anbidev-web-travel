        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            <?php echo isset($data[0]['nama_contact_us']) ? $data[0]['nama_contact_us'] : 'Null'; ?></h4>
                            <hr>
                            <p class="card-text">
                                <?php echo isset($data[0]['nama_contact_us']) ? $data[0]['deskripsi'] : 'Mohon Maaf, Deskripsi tidak bisa ditampilkan'; ?>
                            </p>
